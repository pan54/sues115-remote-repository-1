...
<Project Type="Project" LVVersion="18008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="dialogs" Type="Folder">
			<Item Name="waveform list.vi" Type="VI" URL="../dialogs/waveform list.vi"/>
		</Item>
		<Item Name="document" Type="Folder"/>
		<Item Name="file storage" Type="Folder">
			<Item Name="初始设置.vi" Type="VI" URL="../file storage/初始设置.vi"/>
			<Item Name="阵型选择.vi" Type="VI" URL="../file storage/阵型选择.vi"/>
			<Item Name="通道.vi" Type="VI" URL="../file storage/通道.vi"/>
		</Item>
		...
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="DAQ设置.vi" Type="VI" URL="../dialogs/DAQ设置.vi"/>
			...
			<Item Name="Sub_GuidanceMatrix.vi" Type="VI" URL="../dialogs/Sub_GuidanceMatrix.vi"/>
			<Item Name="Z_DAS - Copy.vi" Type="VI" URL="../algorithm/Z_DAS - Copy.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="COLORBAR1.vi" Type="VI" URL="../../../Message Framework/algorithm/COLORBAR1.vi"/>
